        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-green-50 via-blue-50 to-purple-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 p-4 transition-colors duration-300">
                ...
                >
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">OTP Sent!</h2>
                    <p className="text-gray-600 dark:text-gray-400 mb-6">
                        We've sent a 6-digit OTP to your email. Please verify it within 5 minutes.
                    </p>
                    <p className="text-sm text-gray-500 dark:text-gray-500">Redirecting to verification page...</p>
                </motion.div>
            </div>
        )
    }
